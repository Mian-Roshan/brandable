...
import {
    notFound
} from "../../views/front/components/AllImages"
const NotFound = () => {
    ...
    return (
        <div className="px-5 text-center my-5 py-5">
            ...
            <h5 className="mt-5 f-30px font-boldest">Page Not Found</h5>
            <button className="bg-brand-blue mt-5 d-flex mx-auto align-items-center 

      ...
      <Navbar bg="white" expand="lg" className="px-5 nav-shadow-bottom">
        <Container fluid>
          ...
          <Navbar.Collapse id="brandable-nav">
            <Nav>
              <NavLink activeClassName="active"  to="/designer/myProjects" className={ClassesLink}>My Project</NavLink>
              <NavLink activeClassName="active"  to="/designer/myAssets" className={ClassesLink}>My Assets</NavLink>
              <NavLink activeClassName="active"  to="/designer/myKit" className={ClassesLink}>My Kit</NavLink>
            </Nav>

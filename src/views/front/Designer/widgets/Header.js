      ...
      <Navbar bg="white" expand="lg" className="px-5 nav-shadow-bottom">
        <Container fluid>
          ...
          <Navbar.Collapse id="brandable-nav">
            <Nav>
              <NavLink activeClassName="active"  to="/designer/myAssets" className={ClassesLink}>Home</NavLink>
              <NavLink activeClassName="active"  to="/designer/myProjects" className={ClassesLink}>Projects</NavLink>
              <NavLink activeClassName="active"  to="/designer/myAssets" className={ClassesLink}>Assets</NavLink>
              <NavLink activeClassName="active"  to="/designer/myAssets" className={ClassesLink}>Templates</NavLink>
              <NavLink activeClassName="active"  to="/designer/myKit" className={ClassesLink}>Brand Kit</NavLink>
            </Nav>
            <div className="right-nav-content ms-auto">
              <div className="right-content-btn d-flex align-items-center flex-wrap">
                <div className="me-3">
                  <Link to="/designer/newProject" className="bg-brand-blue d-flex align-items-center
                ...
                <div className="notify-bell me-3">
                  <Link to="/designer/notifications" className="text-black">
                    <Bell size={20}></Bell>
                  </Link>  
                </div>
                <Dropdown className="no-icon custiom-dropdown">
                  ...
                  <Dropdown.Menu style={{right:"0"}}>
                    <div className="dropdown-item">
                      <Link to="/designer/settings" className="text-decoration-none text-black f14-size font-bolder">Settings</Link>
                    </div>
                  </Dropdown.Menu>
                </Dropdown>
              </div>

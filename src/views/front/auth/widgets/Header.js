        ...
        <div className="col-12 align-self-start">
            <div className="d-flex flex-wrap">
                <a href="#" className="text-decoration-none topBar-brand d-flex align-items-center">
                    <img src={props.image} className="me-3" alt="Brandable" />
                    <span className="brand-name font-bolder align-self-center text-white">Brandable</span>
                </a>
                <div className="home-btn align-self-center ms-5">

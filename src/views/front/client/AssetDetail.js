                ...
                <Container fluid>          
                    <Row className="mx-0">
                        ...
                        <Col lg={4} xs={12} className="mt-2">
                            <button className="border-0 gr-gredient2 text-center text-white font-bolder f14-size py-2 px-3 radius6">
                                <ShareFill className="me-2" /> Share
                            </button>
                        </Col>    
                    </Row>
                </Container>

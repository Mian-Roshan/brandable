...
const AssetsFiles= (props) => {
    return (
        <React.Fragment>
            <Link to={props.url} className="text-decoration-none d-block">
                ...
                <div className="d-flex align-items-center">
                    <div className="file-title mt-3 text-overflow-style">
                        <h3 className="mb-0 f20-size font-boldest me-2 f15-size text-black text-overflow-style">{props.title}</h3>
                    </div>
                ...
                <div className="d-flex">
                    <div className="file-filterBy mt-3 me-2">
                        <p className="mb-0 font-semi f14-size color-grey">{props.filter}</p>
                    </div>

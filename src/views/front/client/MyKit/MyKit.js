    ...
    return (
        <div className="main-wrap">
            ...
            <div className="px-lg-5 px-md-4 px-3 pb-5 pt-5">
                <Container fluid>
                    <h5 className="mb-0 font-boldest f20-size">Brand Logos</h5>
                    ...
                    <div className="typography-section mt-5">
                        <Row>
                            <Col xs={12} md={6} xl={4} className="mb-4 pe-4">
                               <h5 className="mb-0 font-boldest f20-size mb-4">Brand Colours</h5>
                            ...
                            <Col xs={12} md={6} xl={4} className="mb-4 pe-4">
                               <h5 className="mb-0 font-boldest f20-size mb-4">Brand Fonts</h5>
                                <div className="border radius10 py-3 px-4 d-flex flex-wrap">
                                   <div class="headingStyles pt-3">
                                       <h3 className="font-boldest mb-3 f20-size text-grey">Add a heading style</h3>
                                ...
                                <div className="uplaoded-font-view">
                                   <h5 className="font-boldest f20-size my-4 align-items-center">Brand Fonts</h5>
                                    <div className="border d-flex flex-wrap p-2  mb-2  radius4">
                                       <span className="font-name align-self-center f12-size me-3 font-boldest">Poppins 200</span>
